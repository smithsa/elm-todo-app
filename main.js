	...
	return _Utils_Tuple2(
		{
			...
			tasks: _List_fromArray(
				[
					{
					description: author$project$Main$NotEditing('Dog needs to be waled everyday'),
					id: 2,
					name: 'Walk the Dog',
					status: author$project$Main$Incomplete
				},
					{
					description: author$project$Main$NotEditing('Must pick up groceries'),
					id: 1,
					name: 'Groceries',
					status: author$project$Main$Incomplete
				}
				]),
			visibleTasks: author$project$Main$AllTasks
		},
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							tasks: A2(
								elm$core$List$map,
								A2(author$project$Main$updateTaskStatus, task.id, author$project$Main$Complete),
								model.tasks)
						}),
					elm$core$Platform$Cmd$none);
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							tasks: A2(
								elm$core$List$map,
								A2(author$project$Main$updateTaskStatus, task.id, author$project$Main$Incomplete),
								model.tasks)
						}),
					elm$core$Platform$Cmd$none);
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							tasks: A2(
								elm$core$List$map,
								author$project$Main$triggerEditableDescription(task.id),
								model.tasks)
						}),
					elm$core$Platform$Cmd$none);
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							tasks: A2(
								elm$core$List$map,
								A2(author$project$Main$updateTaskDescriptionBuffer, task.id, val),
								model.tasks)
						}),
					elm$core$Platform$Cmd$none);
	...
	if (!author$project$Main$taskComplete(task)) {
		...
		if (_n0.$ === 'NotEditing') {
			...
			return A2(
				...
				_Utils_Tuple2(
					'click',
					author$project$Main$TriggerDescriptionEdit(task)),
				A2(
					visotype$elm_dom$Dom$appendText,
					val,
					A2(
					...
					[
						...
						A2(
							...
							A2(
								...
								author$project$Main$UpdateTaskDescriptionBuffer(task),
								visotype$elm_dom$Dom$element('input')))),
						A2(
						visotype$elm_dom$Dom$addAction,
						_Utils_Tuple2(
							'click',
							author$project$Main$EditDescription(task)),
						A2(
							visotype$elm_dom$Dom$addClass,
							'save',
							A2(
						...
						_Utils_Tuple2(
							'click',
							author$project$Main$CancelEditDescription(task)),
						A2(
							visotype$elm_dom$Dom$addClass,
							'cancel',
							A2(
...
var author$project$Main$taskToggleCompleteButton = function (task) {
	return author$project$Main$taskComplete(task) ? A2(
		...
		_Utils_Tuple2(
			'click',
			author$project$Main$UndoTaskCompletion(task)),
		A2(
			visotype$elm_dom$Dom$addClass,
			'undo',
			A2(
		...
		_Utils_Tuple2(
			'click',
			author$project$Main$CompleteTask(task)),
		A2(
			visotype$elm_dom$Dom$addClass,
			'complete',
			A2(
...
_Platform_export({'Main':{'init':author$project$Main$main(
	A2(
		...
		A2(elm$json$Json$Decode$field, 'taskCount', elm$json$Json$Decode$int)))(0)}});}(this));