...
var author$project$Types$completionStatusFromString = function (completionStatusString) {
...
var author$project$Types$completionStatusDecoder = A2(elm$json$Json$Decode$map, author$project$Types$completionStatusFromString, elm$json$Json$Decode$string);
var author$project$Types$NotEditing = function (a) {
	return {$: 'NotEditing', a: a};
};
var author$project$Types$editableStringDecoder = A2(elm$json$Json$Decode$map, author$project$Types$NotEditing, elm$json$Json$Decode$string);
var elm$json$Json$Decode$field = _Json_decodeField;
var elm$json$Json$Decode$int = _Json_decodeInt;
var elm$json$Json$Decode$map4 = _Json_map4;
var author$project$Types$taskDecoder = A5(
	elm$json$Json$Decode$map4,
	author$project$Types$Task,
	A2(elm$json$Json$Decode$field, 'id', elm$json$Json$Decode$int),
	A2(elm$json$Json$Decode$field, 'name', elm$json$Json$Decode$string),
	A2(elm$json$Json$Decode$field, 'description', author$project$Types$editableStringDecoder),
	A2(elm$json$Json$Decode$field, 'status', author$project$Types$completionStatusDecoder));
var elm$json$Json$Decode$list = _Json_decodeList;
var author$project$Types$tasksDecoders = elm$json$Json$Decode$list(author$project$Types$taskDecoder);
var elm$core$Platform$Cmd$batch = _Platform_batch;
var elm$core$Platform$Cmd$none = elm$core$Platform$Cmd$batch(_List_Nil);
var elm$json$Json$Decode$decodeValue = _Json_run;
var author$project$Main$initialModel = function (flags) {
	var _n0 = A2(elm$json$Json$Decode$decodeValue, author$project$Types$tasksDecoders, flags.tasks);
	if (_n0.$ === 'Ok') {
		var tasks = _n0.a;
...
var author$project$Main$cancelEditDescription = F2(
	function (taskId, task) {
		if (_Utils_eq(taskId, task.id)) {
			var _n0 = task.description;
			if (_n0.$ === 'Editing') {
				var val = _n0.a;
...
var author$project$Main$deleteTask = F2(
	function (taskId, tasks) {
		return A2(
			elm$core$List$filter,
			function (currentTask) {
				return !_Utils_eq(currentTask.id, taskId);
			},
			tasks);
	});
var author$project$Main$editDescription = F2(
	function (taskId, task) {
		if (_Utils_eq(taskId, task.id)) {
			var _n0 = task.description;
			if (_n0.$ === 'Editing') {
...
var author$project$Main$nextTaskId = function (tasks) {
	return A3(
		elm_community$maybe_extra$Maybe$Extra$unwrap,
		0,
		function (lastTaskAdded) {
			return lastTaskAdded.id + 1;
		},
...
var author$project$Main$triggerEditableDescription = F2(
	function (taskId, task) {
		if (_Utils_eq(taskId, task.id)) {
			var _n0 = task.description;
			if (_n0.$ === 'Editing') {
...
var author$project$Main$updateTaskDescriptionBuffer = F3(
	function (taskId, inputVal, task) {
		if (_Utils_eq(taskId, task.id)) {
			var _n0 = task.description;
			if (_n0.$ === 'Editing') {
				var val = _n0.a;
...
var author$project$Main$updateTaskStatus = F3(
	function (taskId, completionStatus, task) {
		return _Utils_eq(taskId, task.id) ? _Utils_update(
			task,
			{status: completionStatus}) : task;
	});
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							tasks: A2(
								elm$core$List$map,
								author$project$Main$triggerEditableDescription(taskId),
								model.tasks)
						}),
					elm$core$Platform$Cmd$none);
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							tasks: A2(
								elm$core$List$map,
								author$project$Main$editDescription(taskId),
								model.tasks)
						}),
					elm$core$Platform$Cmd$none);
			case 'UpdateTaskDescriptionBuffer':
				var taskId = msg.a;
				var val = msg.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							tasks: A2(
								elm$core$List$map,
								A2(author$project$Main$updateTaskDescriptionBuffer, taskId, val),
								model.tasks)
						}),
					elm$core$Platform$Cmd$none);
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							tasks: A2(
								elm$core$List$map,
								author$project$Main$cancelEditDescription(taskId),
								model.tasks)
						}),
					elm$core$Platform$Cmd$none);
			default:
				var visibleTasksType = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
...
var author$project$Types$completionStatusEncoder = function (completionStatus) {
...
var author$project$Types$editableStringEncoder = function (editableString) {
...
var author$project$Types$taskEncoder = function (task) {
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'description',
				author$project$Types$editableStringEncoder(task.description)),
				_Utils_Tuple2(
				'status',
				author$project$Types$completionStatusEncoder(task.status))
			]));
};
...
var author$project$Types$tasksEncoder = function (tasks) {
	return A2(elm$json$Json$Encode$list, author$project$Types$taskEncoder, tasks);
};
var author$project$Main$updateWithStorage = F2(
	function (msg, model) {
		...
		var newModel = _n0.a;
		var commands = _n0.b;
		var extractedTasks = author$project$Types$tasksEncoder(newModel.tasks);
		return _Utils_Tuple2(
			newModel,
...
var author$project$Main$filteredTaskListElements = F2(
	function (visibleTask, tasks) {
		switch (visibleTask.$) {
			case 'AllTasks':
				return tasks;
			case 'CompleteTasks':
...
var visotype$elm_dom$Dom$Internal$modify = F2(
	function (f, _n0) {
		var data = _n0.a;
		return visotype$elm_dom$Dom$Internal$Element(
			f(data));
	});
var visotype$elm_dom$Dom$addAction = function (_n0) {
	var event = _n0.a;
	var msg = _n0.b;
...
var visotype$elm_dom$Dom$Internal$render = function (_n0) {
	var data = _n0.a;
		...
		if (_n5 === '') {
			...
			return elm$core$List$cons(
				A2(
					...
					elm$virtual_dom$VirtualDom$text(data.text)));
		}
	}();
		...
		if (_n3 === '') {
			...
			return elm$core$List$cons(
				A2(
					...
					'id',
					elm$json$Json$Encode$string(data.id)));
		}
	}();
	var consClassName = function () {
		var _n2 = data.classes;
		if (!_n2.b) {
			return function (x) {
				return x;
			};
			...
			return elm$core$List$cons(
				A2(
					...
					elm$json$Json$Encode$string(
						A2(elm$core$String$join, ' ', data.classes))));
		}
	}();
	var allAttributes = consId(
		consClassName(
			prependStyles(
				prependListeners(data.attributes))));
	var _n1 = _Utils_Tuple2(data.namespace, data.keys);
	if (_n1.a === '') {
		if (!_n1.b.b) {
			return A3(
			...
			return A3(
				...
				allAttributes,
				consTextKeyed(
					A3(elm$core$List$map2, elm$core$Tuple$pair, data.keys, data.children)));
		}
	} else {
		if (!_n1.b.b) {
			return A4(
	...
	return visotype$elm_dom$Dom$Internal$modify(
		function (n) {
			return _Utils_update(
				n,
				{
					children: A2(elm$core$List$append, n.children, lr)
				});
		});
};
	...
	return visotype$elm_dom$Dom$Internal$modify(
		function (n) {
			return _Utils_update(
				n,
				{
					text: A2(elm$core$String$append, n.text, s)
				});
		});
};
...
var author$project$Main$taskFilterElements = A2(
...
var author$project$Main$CancelEditDescription = function (a) {
	return {$: 'CancelEditDescription', a: a};
};
var author$project$Main$EditDescription = function (a) {
	return {$: 'EditDescription', a: a};
};
var author$project$Main$TriggerDescriptionEdit = function (a) {
	return {$: 'TriggerDescriptionEdit', a: a};
};
var author$project$Main$UpdateTaskDescriptionBuffer = F2(
	function (a, b) {
...
var author$project$Main$taskDescriptionElement = function (task) {
	if (!author$project$Main$taskComplete(task)) {
		var _n0 = task.description;
		if (_n0.$ === 'NotEditing') {
			var val = _n0.a;
			return A2(
				...
				_Utils_Tuple2(
					'click',
					author$project$Main$TriggerDescriptionEdit(task.id)),
				A2(
					visotype$elm_dom$Dom$appendText,
					val,
					A2(
					...
					[
						...
						A2(
							...
							A2(
								...
								author$project$Main$UpdateTaskDescriptionBuffer(task.id),
								visotype$elm_dom$Dom$element('input')))),
						A2(
						visotype$elm_dom$Dom$addAction,
						_Utils_Tuple2(
							'click',
							author$project$Main$EditDescription(task.id)),
						A2(
							visotype$elm_dom$Dom$addClass,
							'save',
							A2(
						...
						_Utils_Tuple2(
							'click',
							author$project$Main$CancelEditDescription(task.id)),
						A2(
							visotype$elm_dom$Dom$addClass,
							'cancel',
							A2(
...
var author$project$Main$taskName = function (task) {
	return A3(
		visotype$elm_dom$Dom$addStyleConditional,
		_Utils_Tuple2('text-decoration', 'line-through'),
		author$project$Main$taskComplete(task),
		A2(
			visotype$elm_dom$Dom$appendText,
			task.name,
...
var author$project$Main$UndoTaskCompletion = function (a) {
	return {$: 'UndoTaskCompletion', a: a};
};
var author$project$Main$taskToggleCompleteButton = function (task) {
	return author$project$Main$taskComplete(task) ? A2(
		visotype$elm_dom$Dom$addAction,
		_Utils_Tuple2(
			'click',
			author$project$Main$UndoTaskCompletion(task.id)),
		A2(
			visotype$elm_dom$Dom$addClass,
			'undo',
			A2(
				visotype$elm_dom$Dom$appendText,
				'Undo',
				visotype$elm_dom$Dom$element('button')))) : A2(
		visotype$elm_dom$Dom$addAction,
		_Utils_Tuple2(
			'click',
			author$project$Main$CompleteTask(task.id)),
		A2(
			visotype$elm_dom$Dom$addClass,
			'complete',
			A2(
...
var author$project$Main$taskListElement = function (task) {
	return A2(
		visotype$elm_dom$Dom$appendChildList,
		_List_fromArray(
			[
				author$project$Main$taskName(task),
				author$project$Main$taskToggleCompleteButton(task),
				A2(
				visotype$elm_dom$Dom$addAction,
				_Utils_Tuple2(
					'click',
				...
				A2(
					...
					'delete',
					visotype$elm_dom$Dom$element('span'))),
				author$project$Main$taskDescriptionElement(task)
			]),
...
var author$project$Main$view = function (model) {
	return visotype$elm_dom$Dom$render(
		A2(
			...
			_List_fromArray(
				[
					author$project$Main$taskFilterElements,
					A2(
					visotype$elm_dom$Dom$appendChildList,
					_List_fromArray(
						[
							A2(
							visotype$elm_dom$Dom$addInputHandler,
							author$project$Main$UpdateInputTaskName,
							A2(
								visotype$elm_dom$Dom$addAttributeList,
								_List_fromArray(
									[
										elm$html$Html$Attributes$value(model.inputTaskName),
							...
							A2(
							visotype$elm_dom$Dom$addAction,
							_Utils_Tuple2('click', author$project$Main$AddTask),
							A2(
								visotype$elm_dom$Dom$appendText,
								'Add Task',
								A2(
					...
					A2(
						elm$core$List$map,
						author$project$Main$taskListElement,
						A2(author$project$Main$filteredTaskListElements, model.visibleTasks, model.tasks)),
